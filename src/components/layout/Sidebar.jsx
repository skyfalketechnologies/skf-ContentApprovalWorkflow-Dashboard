  ...
  return (
    <aside className={`sidebar${collapsed ? ' collapsed' : ''}`}>
      ...
      <div className="sidebar-footer">
        ...
        <button type="button" className="btn btn-secondary" onClick={onOpenProfileSettings}>
          <SettingsIcon />
